...
const validEmail = (val) => /^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,10}$/i.test(val);
...
class Contact extends Component {
    ...
    //     // regular expressions-> this says all the char should be string of numbers
    //     const reg = /^\d+$/;
